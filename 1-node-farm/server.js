...
const templateOverview = await readFile(
  fileURLToPath(import.meta.resolve('./templates/template-overview.html')),
  'utf-8'
);
const templateProduct = await readFile(
  fileURLToPath(import.meta.resolve('./templates/template-product.html')),
  'utf-8'
);
const templateCard = await readFile(
  fileURLToPath(import.meta.resolve('./templates/template-card.html')),
  'utf-8'
);

const data = await readFile(
  fileURLToPath(import.meta.resolve('./dev-data/data.json')),
  'utf-8'
);
